---
name: skill-creator
description: Creates new skills for AI agents following Antigravity conventions. Use when building new skills, creating SKILL.md files, or extending agent capabilities.
---
